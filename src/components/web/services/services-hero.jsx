...
const defaultContent = {
  title: "Our Services",
  subtitle: "Comprehensive Bus Travel Solutions",
  description:
    "Discover our range of services designed to make your bus travel experience seamless, comfortable, and enjoyable.",
};
